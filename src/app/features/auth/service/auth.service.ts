...
import { UserDatas, UserDatasLogin, UserDatasSignUp, baseUrl } from 'src/app/shared/constantes/constantes';
...
export class AuthService {
	...
	createUser(userDatas: UserDatasSignUp) {
		...
		return this.http.post<UserDatas>(`${baseUrl}/user/create`, userDatas, httpOptions).pipe(
			take(1)
		)
	}
